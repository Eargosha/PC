...
# Функции формул (от a to и) с задачи, везде i является элементом последовательности
def a(i):
    return i
...
if __name__ == '__main__':
    ...
    # Нет, функция sympy.simplify не возвращает строку. Она возвращает символьное выражение (объект типа sympy.Expr),
